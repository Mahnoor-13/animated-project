  ...
  return (
    ...
    <div className="all-cards">
      ...
      <div className="images wow animate__fadeInTopLeft" data-wow-duration="1s">
        <img src={require("../images/img.svg")} width="300" />
        <p className="para">
          Adding a little animation to a website can make it eye-popping.
          exceptionally impressive.
        </p>
        <button className="wow animate__bounceInDown" data-wow-duration="1s">Welcome</button>
      </div>

      <div className="images wow animate__slideInDown" data-wow-duration="1s">
        <img src={require("../images/img3.png")} width="300" />
        <p className="para">
          Adding a little animation to a website can make it eye-popping.
          exceptionally impressive.
        </p>
      ...
      >
        <img src={require("../images/dev2.png")} width="300" />
        <p className="para">
          Adding a little animation to a website can make it eye-popping.
          exceptionally impressive.
        </p>
